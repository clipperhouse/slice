...
func TestPointerSingle(t *testing.T) {
	...
	s1, err1 := things.Single(func(x *PointerThing) bool {
		return x.Name == "Third"
	})
	...
	_, err2 := things.Single(func(x *PointerThing) bool {
		return x.Name == "Second"
	})
	...
	_, err3 := things.Single(func(x *PointerThing) bool {
		return x.Name == "Dummy"
	})
	...
	_, err4 := PointerThingSlice{}.First(func(x *PointerThing) bool {
		return true
	})
