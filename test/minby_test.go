...
func TestPointerMinBy(t *testing.T) {
	...
	min1, err1 := things.MinBy(func(a, b *PointerThing) bool {
		return a.Number < b.Number
	})
	...
	expected1 := &PointerThing{"Second", -20}
	if *min1 != *expected1 {
		t.Errorf("MinBy Number should return %v, got %v", expected1, min1)
	}

	_, err2 := PointerThingSlice{}.MinBy(func(a, b *PointerThing) bool {
		return true
	})
