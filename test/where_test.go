...
func TestPointerWhere(t *testing.T) {
	...
	where1 := things.Where(func(x *PointerThing) bool {
		return x.Name == "Second"
	})

	expected1 := PointerThingSlice{
		{"Second", 0},
		{"Second", 10},
	}
	...
	where2 := things.Where(func(x *PointerThing) bool {
		return x.Name == "Dummy"
	})
	...
	where3 := PointerThingSlice{}.Where(func(x *PointerThing) bool {
		return true
	})
